...
class DecodingOptions {
  ...
  factory DecodingOptions.fromJson(Map<String, dynamic> json) {
    return DecodingOptions(
      ...
      temperatureIncrementOnFallback: json['temperatureIncrementOnFallback'] != null
      ...
      clipTimestamps: (json['clipTimestamps'] as List<dynamic>?)?.cast<double>() ?? [],
      ...
      supressTokens: (json['supressTokens'] as List<dynamic>?)?.cast<int>() ?? [],
      compressionRatioThreshold:
          json['compressionRatioThreshold'] != null ? (json['compressionRatioThreshold'] as num).toDouble() : null,
      logProbThreshold: json['logProbThreshold'] != null ? (json['logProbThreshold'] as num).toDouble() : null,
      firstTokenLogProbThreshold:
          json['firstTokenLogProbThreshold'] != null ? (json['firstTokenLogProbThreshold'] as num).toDouble() : null,
      ...
      chunkingStrategy: json['chunkingStrategy'] == 'vad' ? ChunkingStrategy.vad : ChunkingStrategy.none,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'chunkingStrategy': chunkingStrategy == ChunkingStrategy.vad ? 'vad' : 'none',
    };
  }
}
