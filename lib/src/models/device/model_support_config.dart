...
class ModelSupportConfig {
  ...
  factory ModelSupportConfig.fromJson(Map<String, dynamic> json) {
    ...
    final List<DeviceSupport> deviceSupports =
        (json['deviceSupports'] as List?)?.map((e) => DeviceSupport.fromJson(e as Map<String, dynamic>)).toList() ?? [];

    // Parse known models
    final List<String> knownModels = (json['knownModels'] as List?)?.map((e) => e as String).toList() ?? [];
