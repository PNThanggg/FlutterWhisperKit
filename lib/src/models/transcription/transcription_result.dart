...
class TranscriptionSegment {
  ...
  factory TranscriptionSegment.fromJson(Map<String, dynamic> json) {
    return TranscriptionSegment(
      ...
      tokens: json['tokens'] != null ? (json['tokens'] as List).map((e) => e as int).toList() : [],
  ...
  factory TranscriptionTimings.fromJson(Map<String, dynamic> json) {
    return TranscriptionTimings(
      ...
      encoderSpecializationTime:
          json['encoderSpecializationTime'] != null ? (json['encoderSpecializationTime'] as num).toDouble() : 0.0,
      decoderSpecializationTime:
          json['decoderSpecializationTime'] != null ? (json['decoderSpecializationTime'] as num).toDouble() : 0.0,
      ...
      decodingWordTimestamps:
          json['decodingWordTimestamps'] != null ? (json['decodingWordTimestamps'] as num).toDouble() : 0.0,
      decodingNonPrediction:
          json['decodingNonPrediction'] != null ? (json['decodingNonPrediction'] as num).toDouble() : 0.0,
      totalAudioProcessingRuns:
          json['totalAudioProcessingRuns'] != null ? (json['totalAudioProcessingRuns'] as num).toDouble() : 0.0,
      ...
      totalTimestampAlignmentRuns:
          json['totalTimestampAlignmentRuns'] != null ? (json['totalTimestampAlignmentRuns'] as num).toDouble() : 0.0,
      totalDecodingFallbacks:
          json['totalDecodingFallbacks'] != null ? (json['totalDecodingFallbacks'] as num).toDouble() : 0.0,
      totalDecodingWindows:
          json['totalDecodingWindows'] != null ? (json['totalDecodingWindows'] as num).toDouble() : 0.0,
