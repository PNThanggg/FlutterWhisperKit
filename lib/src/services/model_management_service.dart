...
class ModelManagementService {
  ...
  Future<String?> loadModel(
    ...
    try {
      if (onProgress != null) {
        progressSubscription = FlutterWhisperKitPlatform.instance.modelProgressStream.listen((progress) {
  ...
  Stream<Progress> get modelProgressStream => FlutterWhisperKitPlatform.instance.modelProgressStream;
}
