...
class WhisperKitMessage {
  ...
  Future<String?> setupModels(String? model, String? downloadBase, String? modelRepo, String? modelToken,
      String? modelFolder, bool download) async {
    final String pigeonVar_channelName =
    ...
    final Future<Object?> pigeonVar_sendFuture =
        pigeonVar_channel.send(<Object?>[model, downloadBase, modelRepo, modelToken, modelFolder, download]);
    final List<Object?>? pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<String?> download(
      String variant, String? downloadBase, bool useBackgroundSession, String repo, String? token) async {
    final String pigeonVar_channelName =
    ...
    final Future<Object?> pigeonVar_sendFuture =
        pigeonVar_channel.send(<Object?>[variant, downloadBase, useBackgroundSession, repo, token]);
    final List<Object?>? pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
