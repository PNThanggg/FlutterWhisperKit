...
void main() {
  group('WhisperKitError', () {
    ...
    test('toString should format correctly', () {
      ...
      expect(error.toString(), equals('TranscriptionFailedError(2001): Transcription failed'));
    });
  });
  ...
  group('WhisperKitError factory', () {
    ...
    group('toString', () {
      test('includes error type and message for all error types', () {
        final errors = [
          const ModelLoadingFailedError(message: 'Failed to load model', code: 1001),
          const TranscriptionFailedError(message: 'Transcription failed', code: 2001),
